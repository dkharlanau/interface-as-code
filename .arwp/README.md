...
Audience: Integration owners reviewing operational readiness. Useful action: Validate a sample interface and inspect ownership, monitoring, recovery and acceptance controls.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/interface-as-code/
...
Compare an API schema with an operational integration contract on a documented replay or monitoring gap.
